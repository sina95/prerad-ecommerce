      ...
      <div>
        <Segment attached>
          ...
          <Segment attached>
            <Radio
              label={
                this.props.shipping.data.deliveryMethod
                  .charAt(0)
                  .toUpperCase() +
                this.props.shipping.data.deliveryMethod.slice(1)
              }
              checked
            />
          ...
          <Segment attached>
            <Radio
              label={
                this.props.billing.data.paymentMethod.charAt(0).toUpperCase() +
                this.props.billing.data.paymentMethod.slice(1)
              }
              checked
            />
          </Segment>
        ...
        <Button.Group floated="right">
          ...
          <Button.Or />
          <Button color="red" onClick={this.submit}>
            Place order
          </Button>
        </Button.Group>
      </div>
